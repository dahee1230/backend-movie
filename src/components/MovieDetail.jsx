...
export default function MovieDetail() {
    ...
    if (!movie) {
        return <div className="min-h-screen bg-black text-white flex-tiem-center justify-center">Loading...</div>
    }
    // 영화상세정보
    return (
        <div className="min-h-screen bg-black text-white p-4 py-[80px]">
            <div className="container mx-auto py-8">
                <div className="flex flex-col gap-8 md:flex-row">
                    <img src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} alt="{movie.title}" className="w-fill md:w-1/3 rounded-lg" />
